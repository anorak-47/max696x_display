...
#define MATRIX_CMD_SHOW_VERSION 0x02
...
#define MATRIX_CMD_ANIMATE_TYPEMATRIX (MATRIX_CMD_ANIMATION | 0x03)
#define MATRIX_CMD_ANIMATE_SWEEP (MATRIX_CMD_ANIMATION | 0x04)
#define MATRIX_CMD_ANIMATE_BOX (MATRIX_CMD_ANIMATION | 0x05)

#define MATRIX_FIRST_ANIMATION MATRIX_CMD_ANIMATE_TYPEMATRIX
#define MATRIX_LAST_ANIMATION MATRIX_CMD_ANIMATE_BOX
...
#define MATRIX_CFG_REG_ANIMATION_FIRST 9
#define MATRIX_CFG_REG_ANIMATION_LAST 10

#define MATRIX_MAX_CFG_REG 11
